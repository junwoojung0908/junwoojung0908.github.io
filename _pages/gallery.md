...
<div class="gallery">
  ...
  <div class="gallery-row">
    <div class="gallery-item feature">
    ...
    <div class="gallery-item">
      ...
      <p class="gallery-caption">KSA × Ellen Young School Exchange · Hong Kong, Jan 2023</p>
    </div>
    <div class="gallery-item">
      <img src="/assets/img/gallery/QCL.jpg" alt="QCL Group Photo" loading="lazy">
      <p class="gallery-caption">Quantum Computing Lab · KAIST, 2023</p>
    </div>
  </div>
  ...
  <div class="gallery-row">
    ...
    <div class="gallery-item">
      ...
      <p class="gallery-caption">The inQlings group · NTU Singapore, 2024</p>
    </div>
    <div class="gallery-item">
  ...
  <div class="gallery-row">
    <div class="gallery-item">
      ...
      <p class="gallery-caption">CAMPUS Asia Joint Research Presentation · KAIST, Aug 2025</p>
    </div>
    <div class="gallery-item">
  ...
  <div class="gallery-row">
    <div class="gallery-item feature">
      ...
      <p class="gallery-caption">QISK Conference · Seoul, Feb 2026</p>
    </div>
    <div class="gallery-item">
